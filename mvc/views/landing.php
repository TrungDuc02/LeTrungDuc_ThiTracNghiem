                            ...
                            <div class="text-center slider-team">
                                <div class="p-3 invisible" data-toggle="appear" data-class="animated flipInX">
                                    <a class="block block-rounded bg-gd-primary text-center"
                                        href="https://github.com/TrungDuc02/">
                                        <div class="block-content block-content-full bg-gd-sea">
                                            <img class="img-avatar img-avatar-thumb"
                                                src="https://github.com/TrungDuc02.png?size=460" alt="">
                                        </div>
                                        <div class="block-content block-content-full bg-black-10">
                                            <p class="fw-semibold text-white mb-0">Lê Trung Đức</p>
                                ...
                                <div class="p-3 invisible" data-toggle="appear" data-class="animated flipInX">
                                    <a class="block block-rounded bg-gd-primary text-center"
                                        ...
                                        <div class="block-content block-content-full bg-gd-sea">
                                            <img class="img-avatar img-avatar-thumb"
                                                src="./public/media/avatars/2.jpg" alt="">
                                        </div>
                                        <div class="block-content block-content-full bg-black-10">
                                            <p class="fw-semibold text-white mb-0">ĐỨC</p>
                                            <p class="fs-sm text-white-75 mb-0">
                                                1111
                                            </p>
                                        </div>
                                ...
                                <div class="p-3 invisible" data-toggle="appear" data-class="animated flipInX">
                                    <a class="block block-rounded bg-gd-primary text-center"
                                        ...
                                        <div class="block-content block-content-full bg-gd-sea">
                                            <img class="img-avatar img-avatar-thumb"
                                                src="./public/media/avatars/c3.jpg" alt="">
                                        </div>
                                        <div class="block-content block-content-full bg-black-10">
                                            <p class="fw-semibold text-white mb-0">Michu</p>
                                            <p class="fs-sm text-white-75 mb-0">
                                                2222
                                            </p>
                                        </div>
                                ...
                                <div class="p-3 invisible" data-toggle="appear" data-class="animated flipInX">
                                    <a class="block block-rounded bg-gd-primary text-center"
                                        ...
                                        <div class="block-content block-content-full bg-gd-sea">
                                            <img class="img-avatar img-avatar-thumb"
                                                src="./public/media/avatars/đz.jpg" alt="">
                                        </div>
                                        <div class="block-content block-content-full bg-black-10">
                                            <p class="fw-semibold text-white mb-0">Lê Trung Duck</p>
                                            <p class="fs-sm text-white-75 mb-0">
                                                3333
                                            </p>
                                        </div>
